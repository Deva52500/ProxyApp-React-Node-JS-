This web application aggregates various proxies from different providers and presents them in a single UI, the methodology for accessing the proxy list from various providers. 
